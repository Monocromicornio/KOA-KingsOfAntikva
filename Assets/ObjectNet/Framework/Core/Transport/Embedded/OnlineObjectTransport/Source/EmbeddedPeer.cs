    ...
    public abstract class EmbeddedPeer
    {
        ...
        protected void HandleData(object _, DataReceivedEventArgs e)
        {
            ...
            else
            {
                ...
                ushort sequenceId = EmbeddedConverter.UShortFromBits(e.DataBuffer, EmbeddedMessage.HeaderBits);
                if (e.FromConnection.HandleReliableData(sequenceId, messagesToHandle, e) == false)
